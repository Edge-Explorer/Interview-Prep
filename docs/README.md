# 📚 InterviewAI — Project Documentation Index

This folder contains all internal design documents, planning files, and engineering notes for the **InterviewAI** platform.
...
> **Note**: The main project `README.md` lives in the root of the repository, as required by GitHub.
> All supporting documentation lives here in `/docs`.
